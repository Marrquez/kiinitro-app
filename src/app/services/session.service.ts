...
export class SessionService {
  ...
  public muscles = [[{name:'Pecho-Bíceps-Abdomen',id:0},{name:'Espalda-Tríceps-Abdomen',id:1},{name:'Muslos-Abdomen',id:2},{name:'Pantorilla-Abdomen',id:3},{name:'Hombros-Trapecio-Abdomen',id:4}],[{name:'Pecho-Abdomen',id:0},{name:'Espalda-Abdomen',id:1},{name:'Biceps-Tríceps-Abdomen',id:2},{name:'Hombros-Trapecio-Abdomen',id:3},{name:'Muslos-Pantorrilla-Abdomen',id:4}],[{name:'Muslos-Pantorrilla-Abdomen',id:0},{name:'Pecho-Tríceps-Bíceps-Abdomen',id:0},{name:'Espalda-Hombros-Abdomen',id:0}]];
  ...
  public index = ['Pecho','Espalda','Muslos','Pantorrilla','Bíceps','Tríceps','Hombros','Trapecio','Abdomen'];
  public group = [];
  public fullData = [];
  public pecho = [];
  public espalda = [];
